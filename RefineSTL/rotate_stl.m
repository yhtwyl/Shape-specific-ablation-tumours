...
%    tri(:,1:3:end) = tri(:,1:3:end)- min(min(tri(:,1:3:end))); % x_prob
%    tri(:,2:3:end) = tri(:,2:3:end) - min(min(tri(:,2:3:end))); % y_prob
%    tri(:,3:3:end) = tri(:,3:3:end) - min(min(tri(:,3:3:end))); % z_prob
end