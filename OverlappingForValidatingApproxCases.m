function [TargetData,slice_value] = OverlappingForValidatingApproxCases(filename,grid_points,fig_name)
    % grid_points = 100;
    ...
    for slice_value = bottom_slice_value:top_slice_value
        ...
        [AverageDiaCurrentSlice(1,slice_value - bottom_slice_value + 1),~] = ...
            FakeDoesEverything(x_mat,y_mat,z_mat,v_mat,slice_plane,slice_value,azimuthal_angle,delta_x,delta_y,'no',fig_name);
        index = index + 1;
    end
    % pause(2);
    ...
    [~,TargetData] = FakeDoesEverything(x_mat,y_mat,z_mat,v_mat,slice_plane,slice_value,azimuthal_angle,delta_x,delta_y,'yes',fig_name);
end