...
for i = 1:3
    ...
    for slice_value = BottomSliceValue:TopSliceValue
        NiceDataCutPlane = RefineStlSliceFlip(Slices{slice_value},i,-theta_rot(i));
        [AverageDiaCurrentSlice(1,slice_value - BottomSliceValue + 1),~,~,~,~,~,~,~] = DoesEveryThingCtTumourSTL(NiceDataCutPlane,'no',fig1);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [~,l1(1),l1(2),w1(1),w1(2),intersection_coords_length, intersection_coords_width,bb] = DoesEveryThingCtTumourSTL(NiceDataCutPlane,'yes',fig1);
