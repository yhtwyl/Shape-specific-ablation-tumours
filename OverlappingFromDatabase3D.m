...
function [StatesOfAllNineTines, area, VerticalAblationLimits] = OverlappingFromDatabase3D(Refined_M,fig1)
    VerticalAblationLimits = [];
    ...
    if size(DetailedMatrixLevel3_sorted,1) ~= 0
        ...
        for j = 1:fix(length(ApproximatedStates)/8)
            ...
            case 1
                DirectoryOfDataFile = 'C:\Users\2016m\Documents\MATLAB\Overlapping\HalfModel';
                nature = 1;% 1 = "Symmetric";
                similar = 0;
            case 2
                DirectoryOfDataFile = 'C:\Users\2016m\Documents\MATLAB\Overlapping\FullModel';
                nature = 0;% 0 = "Unique";
                similar = 0;
            case 3
                DirectoryOfDataFile = 'C:\Users\2016m\Documents\MATLAB\Overlapping\FullModel';
        ...
        %%%% COMMENT THIS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
            ...
            %rotate(fv_r,direction,-angle,origin);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        end
