function [AverageDiaCurrentSlice_,l1,l2,w1,w2,intersection_coords_on_length,intersection_coords_on_width,bb,AreaOfAblationOnSlicePlane] = ...
    DoesEveryThing(x_mat,y_mat,z_mat,v_mat,slice_plane,slice_value,azimuthal_angle,delta_x,delta_y,plot_or_not,fig1)
