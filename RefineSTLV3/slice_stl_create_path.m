function [movelist_all,min_z,max_z] = slice_stl_create_path(triangles,slice_height)
...
%end check
        ...
        movelist =[];
          for i = 1: max(bins)
                    ...
                    movelist1(:,3) = ones(size(movelist1,1),1).*z_slices(k);
                    movelist = [movelist;movelist1; [NaN NaN NaN]]; % [NaN NaN]
